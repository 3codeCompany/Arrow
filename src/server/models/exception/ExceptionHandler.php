...
class ExceptionHandler implements IExceptionHandler
{
    ...
    public function displayException($exception)
    {
        ...
        if ($_SERVER["REMOTE_ADDR"] == "83.142.126.242" || $_SERVER["REMOTE_ADDR"] == "91.240.76.1" || $_SERVER["REMOTE_ADDR"] == "89.77.54.49" || isset($_REQUEST["comp"]) || ($_SERVER["HTTP_HOST"] == "esolocal.com")) {

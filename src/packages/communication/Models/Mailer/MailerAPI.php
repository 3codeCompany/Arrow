...
<<<<<<< HEAD:src/packages/communication/Models/Mailer/MailerAPI.php
            if ($bcc) {
                $message->setBcc(is_array($bcc) ? $bcc : explode(",", $bcc));
            }
=======

>>>>>>> 48b53524a967b453047c1ed0b071d6c459a0526b:src/packages/communication/Models/Mailer/MailerAPI.php
            if ($attachments) {

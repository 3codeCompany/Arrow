    ...
    public render() {
        ...
        return (
            <div>
                ...
                <Modal show={s.add} title={"Dodaj wartość do " + p.parent.label} showHideLink={true} onHide={() => this.setState({ add: false, edited: null })}>
                            ...
                            {(form) => {
                                return (
                                    <>
                                        ...
                                        <BText label={"Nazwa systemowa"} {...form("system_name")} help={"Modyfikuj tylko jeśli wiesz czo robisz!"} />
                                        <button className="pull-right btn btn-primary">{s.edited ? "Zmień" : "Dodaj"}</button>
                                    </>
                                );
                            }}
                        </BForm>

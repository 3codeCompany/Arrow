                    ...
                    <CommandBar
                        ...
                        items={[
                            ...
                            },
                            {
                                ...
                                label: "Załaduj plik",
                                icon: "Upload",
                                onClick: () => this.setState({ isUploading: -1 }),
                            },
                            {
                                key: "f3",
                                label: "Historia tłumaczeń",
                                icon: "History",
                                onClick: () => this.setState({ historyModalVisible: true }),
                            },
                        ]}
                    />
                ) : null}
                                ...
                                Column.text("full_name", fI18n.t("Pobierz"))
                                    .template((value, row) => {
                                        return (
                                            <a
                                                href={
                                                    this.props._basePath + `/data/translate_uploads/${row["full_name"]}`
                                                }
                                                target={"_blank"}
                                            >
                                                <Icon name={"Download"} />
